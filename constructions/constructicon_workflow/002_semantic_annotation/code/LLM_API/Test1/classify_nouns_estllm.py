...
def main():
    parser = argparse.ArgumentParser(
        description="Classify Estonian nouns via EstLLM on Featherless: 1=profession/nationality/role, 0=not."
    )
    ...
    parser.add_argument(
        "output_csv",
        nargs="?",
        default="estllm_vastused.csv",
        help="Output CSV file, e.g. estllm_vastused.csv"
    )

    parser.add_argument(
        "--input_csv",
        default="katse1_unikaalsed_lemmad.csv",
