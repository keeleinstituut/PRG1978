...
OUTPUT_FIELDS = ["instance_form_long", "sentence", "0/1"]
...
def main():
    ...
    parser.add_argument(
        "--input_csv",
        default="katse3_10_gemma.csv",
        help="Input CSV file with instance_form_long and sentence columns, e.g. katse3_10_gemma.csv or katse3_10_gpt.csv"
    )
