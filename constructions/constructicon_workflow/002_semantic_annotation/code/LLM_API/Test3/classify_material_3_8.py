...
OUTPUT_FIELDS = ["instance_form", "sentence", "0/1"]
...
def main():
    ...
    parser.add_argument(
        "--input_csv",
        default="katse3_8_gemma.csv",
        help="Input CSV file with instance_form and sentence columns, e.g. katse3_8_gemma.csv or katse3_8_gpt.csv"
    )
