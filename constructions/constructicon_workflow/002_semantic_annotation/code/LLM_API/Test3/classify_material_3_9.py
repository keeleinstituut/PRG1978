...
OUTPUT_FIELDS = ["instance_form_long", "0/1"]
...
def main():
    ...
    parser.add_argument(
        "--input_csv",
        default="katse3_9_gemma.csv",
        help="Input CSV file with instance_form_long column, e.g. katse3_9_gemma.csv or katse3_9_gpt.csv"
    )
