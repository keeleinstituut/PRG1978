...
DEFAULT_INPUT_CSV = Path(__file__).resolve().parents[1] / "classified_nouns_2_1_zero_values.csv"
...
def read_words(input_csv):
    ...
    with input_path.open("r", encoding="utf-8-sig", newline="") as f:
        ...
        required_headers = {"instance_lemma", "comp1_form", "comp2_lemma"}
...
def main():
    ...
    parser.add_argument(
        "output_csv",
        nargs="?",
        default="classified_materials_2_5.csv",
        help="Output CSV file, e.g. classified_materials_2_5.csv"
    )
