...
DEFAULT_INPUT_CSV = Path(__file__).resolve().parents[1] / "classified_nouns_2_3_zero_values.csv"
...
def main():
    ...
    parser.add_argument(
        "output_csv",
        nargs="?",
        default="classified_materials_2_7.csv",
        help="Output CSV file, e.g. classified_materials_2_7.csv"
    )
