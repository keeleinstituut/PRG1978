...
OUTPUT_FIELDS = ["instance_form_long", "comp1_form", "comp2_form", "0/1"]
...
def read_words(input_csv):
    ...
    with input_path.open("r", encoding="utf-8-sig", newline="") as f:
        ...
        required_fields = {"instance_form_long", "comp1_form", "comp2_form"}
...
def main():
    ...
    parser.add_argument(
        "--input_csv",
        default="katse2_7_gemma.csv",
        help="Input CSV file with instance_form_long, comp1_form, and comp2_form columns, e.g. katse2_7_gemma.csv or katse2_7_gpt.csv"
    )
