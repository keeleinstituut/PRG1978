...
DEFAULT_INPUT_CSV = Path(__file__).resolve().parents[1] / "test_data" / "instance_lemma.csv"
...
def main():
    ...
    parser.add_argument(
        "output_csv",
        nargs="?",
        default="classified_nouns_3_1.csv",
        help="Output CSV file, e.g. classified_nouns_3_1.csv"
    )
    ...
    todo_rows = [
        ...
        if phrase_row["instance_lemma"] not in done_words
    ]
