...
DEFAULT_INPUT_CSV = Path(__file__).resolve().parents[1] / "test_data" / "instance_form.csv"
...
def main():
    ...
    parser.add_argument(
        "output_csv",
        nargs="?",
        default="classified_nouns_3_2.csv",
        help="Output CSV file, e.g. classified_nouns_3_2.csv"
    )
